...
# Create a values file for the umbrella chart so that entire AIABVALUES file
# is passed to each subchart
$(4GUMBRELLAVALUES): $(AIABVALUES) /usr/bin/yq
	...
	# Can't override this at the Helm command line because 'simapp.yaml' in path
...
reset-test:
	...
	cd $(M); rm -f oaisim omec fabric sdcore-helm-charts-4g $(4GUMBRELLAVALUES)
